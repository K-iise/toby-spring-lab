package hello.springbook.learningtest.spring.pointcut;
...
public class PointcutExpressionTest {
    ...
    public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
        ...
        pointcut.setExpression("execution(public int hello.springbook.learningtest.spring.pointcut.Target.minus(int,int))");
